...
export default function EnglishConversationPage() {
  ...
  return (
    <div className="bg-[#F3F3F3]">
      <BreadCrumbs
        title={t("englishConversationBreadcrumbTitle")}
        items={[
          { title: t("englishConversationBreadcrumbHome"), to: "/" },
          { title: t("englishConversationBreadcrumbTitle"), to: "/english-conversation" },
        ]}
      />
        ...
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-xl md:rounded-md bg-white pt-0 pb-[20px]  md:py-[50px]">
          ...
          <div className="bg-white   p-8 pb-0 relative z-20">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-black">
              <span className="text-red-600 font-extrabold">{t("englishConversationAbout")}</span> {t("englishConversationCourse")}
            </h2>
            <div className="flex flex-col gap-4"></div>
            <p className="text-gray-700 text-base md:text-lg leading-[220%]">
              {t("englishConversationAboutText")}
            </p>
          </div>
        </section>
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-md bg-white py-0 md:py-[50px]">
          <img
            src={locale === "en" ? "/courses/english-conversation/about.png" : "/courses/english-conversation/aboutAr.png"}
            ...
            <div className="space-y-8">
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("englishConversationCertificationTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("englishConversationCertificationDescription")}
                </p>
              </div>
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("englishConversationFinalProjectTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("englishConversationFinalProjectDescription")}
                </p>
              </div>
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("englishConversationWeeklyAssignmentsTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("englishConversationWeeklyAssignmentsDescription")}
                </p>
              </div>
            </div>
