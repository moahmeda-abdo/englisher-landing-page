...
export const metadata: Metadata = {
  title: "General English Course | Englisher",
};
...
export default function GeneralEnglishPage() {
  ...
  return (
    <div className="bg-[#F3F3F3]">
      <BreadCrumbs
        title={t("generalEnglishCourse")}
        items={[
          { title: t("generalEnglishBreadcrumbHome"), to: "/" },
          { title: t("generalEnglishBreadcrumbTitle"), to: "/general-english" },
        ]}
      />

      <Container className="px-4 2xl:px-0">
        <section className=" mb-[80px]  px-[0] md:px-[50px] mt-8 rounded-xl md:rounded-md bg-white pt-0 pb-[20px] md:py-[50px]">
          ...
          <div className="bg-white   p-8 relative z-20">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-black">
              <span className="text-red-600 font-extrabold">{t("generalEnglishAbout")}</span> {t("generalEnglishCourse")}
            </h2>
            <div className="flex flex-col gap-4"></div>
            <p className="text-gray-700 text-base md:text-lg leading-[220%]">
              {t("generalEnglishCourseDescription")}
            </p>
          </div>
        </section>
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-md bg-white py-0 md:py-[50px]">
          <img
            src={locale == "ar" ? "/courses/general-english/aboutAr.png" : "/courses/general-english/about.png"}
            ...
            <div className="space-y-8">
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("generalEnglishCertificationTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("generalEnglishCertificationDescription")}
                </p>
              </div>
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("generalEnglishFinalProjectTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("generalEnglishFinalProjectDescription")}
                </p>
              </div>
              ...
              <div className="text-center bg-white py-[25px] rounded-md px-2">
                ...
                <h3 className="text-xl font-bold text-red-600 mb-2">
                  {t("generalEnglishWeeklyAssignmentsTitle")}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed max-w-md mx-auto">
                  {t("generalEnglishWeeklyAssignmentsDescription")}
                </p>
              </div>
            </div>
