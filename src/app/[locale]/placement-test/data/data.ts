...
export const speakingPage = {
    ...
    skills: ['Listening', 'Grammar', 'Vocabulary', 'Pronunciation'],
    reportText:
        'You will receive a report from Englisher Academy via email stating your level (from 1A to 2C), and you can use it as an international reference in any workplace.',
