...
export default function Page() {
    ...
    const breadcrumbs = [
        { title: t("speakingBreadcrumbsHome"), to: "/" },
        { title: t("speakingBreadcrumbsPlacement"), to: "/placement-test/oxford" },
    ];
    ...
    const skills = [
        t("speakingSkillsListening"),
        t("speakingSkillsGrammar"),
        t("speakingSkillsVocabulary"),
        t("speakingSkillsPronunciation"),
    ];
    const reportText = t("speakingReportText");
    const chartImage = t("speakingChartImage");
