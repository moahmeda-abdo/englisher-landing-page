                ...
                <div className="h-full flex flex-col justify-between">
                  ...
                  <div className="flex justify-start items-center gap-6">
                    ...
                    <div className="flex gap-7">
                      {/* WhatsApp */}
                      <a href="#" aria-label="WhatsApp" className="hover:text-red-600 text-black">
                        <BsWhatsapp />
                      </a>
                      {/* LinkedIn */}
                      <a href="#" aria-label="LinkedIn" className="hover:text-red-600 text-black">
                        <ImLinkedin2 />
                      </a>
                      {/* Facebook */}
                      <a href="#" aria-label="Facebook" className="hover:text-red-600 text-black">
                        <CgFacebook />
                      </a>
                      {/* Instagram */}
                      <a href="#" aria-label="Instagram" className="hover:text-red-600 text-black">
                        <AiOutlineInstagram />
                      </a>
                    </div>
                  </div>
