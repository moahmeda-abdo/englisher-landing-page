...
export const metadata: Metadata = {
    title: "English Conversation Course | Englisher",
};
  ...
  return (
    <div className="bg-[#F3F3F3]">
      <BreadCrumbs
        ...
        items={[
          { title: "Home", to: "/" },
          { title: "English Conversation", to: "/english-conversation" },
        ]}
      />
      ...
      <Container className="px-4 2xl:px-0">
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-xl md:rounded-md bg-white pt-0 pb-[20px]  md:py-[50px]">
          ...
          <div className="bg-white   p-8 pb-0 relative z-20">
            ...
            <p className="text-gray-700 text-base md:text-lg leading-[220%]">
              In our conversation course at ENGLISHER, you&apos;ll refine your spoken
              English skills through engaging discussions and interactive
        ...
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-md bg-white py-0 md:py-[50px]">
          <img
            src="/courses/english-conversation/about.png"
