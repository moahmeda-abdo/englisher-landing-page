  ...
  return (
    <div className="bg-[#F3F3F3]">
      <BreadCrumbs
        ...
        items={[
          { title: "Home", to: "/" },
          { title: "General English", to: "/general-english" },
        ]}
      />
        ...
        <section className=" mb-[80px]  px-[0] md:px-[50px] mt-8 rounded-xl md:rounded-md bg-white pt-0 pb-[20px] md:py-[50px]">
          ...
          <div className="bg-white   p-8 relative z-20">
            ...
            <p className="text-gray-700 text-base md:text-lg leading-[220%]">
              In this General English course, you will build strong foundations
              in grammar, vocabulary, and sentence structure. You’ll practice
              all four language skills: listening, speaking, reading, and
              writing — helping you communicate clearly and confidently in daily
              life. The course includes interactive exercises and real-life
              situations to improve your fluency step by step.
            </p>
          </div>
        </section>
        <section className=" mb-[80px]  px-[20] md:px-[50px] mt-8 rounded-md bg-white py-0 md:py-[50px]">
          <img
            src="/courses/general-english/about.png"
